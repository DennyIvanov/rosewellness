...
const zipName = 'rosewellness_v3.zip';
...
const textDomain = 'rosewellness';

// Name of the translation file.
const translationFile = 'rosewellness.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'rosewellness_v3';

// Where can users report bugs.
const bugReport = 'https://github.com/DennyIvanov';

// Last translator Email ID.
const lastTranslator = 'Denis Ivanov, Smart-UI <divanov@smart-ui.pro>';

// Team's Email ID.
const team = '<divanov@smart-ui.pro>';
