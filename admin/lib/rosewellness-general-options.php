<?php
/**
 * Rosewellness General options
 *
 * @package rosewellness
 */

/**
 * Displays Rosewellness General options tab
 *
 * @uses $screen_layout_columns int
 * @param string $pagehook The page hook
 */
function rosewellness_general_options_page( $pagehook ) {
    ...
    <div class="options-main-container">
        ...
        <div class="options-container">
            <form name="rt_general_form" id="rt_general_form" action="options.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="action" value="save_rosewellness_metaboxes_general" />
                <div id="poststuff" class="metabox-holder alignleft">
                    ...
                    <?php submit_button('Reset All General Settings', 'button-link', 'rosewellness_reset', false ); ?>
                </div>
