<?php
/**
 * Rosewellness Post & Comments options
 */

/**
 * Displays Rosewellness Post & Comments options tab
 *
 * @uses $screen_layout_columns int
 * @param srting $pagehook The page hook
 */
function rosewellness_post_comments_options_page( $pagehook ) {
    ...
    <div class="options-main-container">
        ...
        <div class="options-container">
            <form name="rt_post_comments_form" id="rt_post_comments_form" action="options.php" method="post" enctype="multipart/form-data">
                ...
                ?>
                <input type="hidden" name="action" value="save_rosewellness_metaboxes_post_comments" />
                ...
                <div id="poststuff" class="metabox-holder alignleft">
                    ...
                    <?php submit_button('Reset All Post &amp; Comments Settings', 'button-link', 'rosewellness_reset', false ); ?>
                </div>
