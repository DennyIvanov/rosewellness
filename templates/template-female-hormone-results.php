...
/**
 * Template Name: Female Hormone Result Summary
...
// Get Threshold Data
$threshold_message = get_post_meta($post_id, 'female_hormone_threshold_message', true);
...
$patient_details = array(
	...
	'LeadSource' => 'Female Hormone Quiz - RW'
);
				...
				<div class="thank_you_message grey_box immune_score green-tick">
					...
					<?php
					    ...
					    if($entry_fields[90]['value'] < $threshold_level_score_1) {
							...
							echo $threshold_message['threshold_level_4_message'];
							
						} else if(($entry_fields[90]['value'] > $threshold_level_score_3)) {
							
							echo $threshold_message['threshold_level_5_message'];
