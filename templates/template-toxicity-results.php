<?php
/**
 * Template Name: Toxicity Result Summary
...
// Get Threshold Data
$threshold_message = get_post_meta($post_id, 'toxicity_threshold_message', true);
...
$patient_details = array(
	...
	'Company' => '1',
	'Interests__c' => $entry_fields[224]['value'],
    'Secondary_Health_Concern__c' => 'Digestive Health',
	'Residency_State__c' => $entry_fields[223]['value'],
	'LeadSource' => 'Toxicity Quiz - RW'
);
        ...
        <div class="full-width-page-content">
            <div class="container">
				...
				<div class="thank_you_message orange_box">
					<p><strong>Thank you for completing the <strong>Toxicity Questionnaire</strong> and learning more about your health. Here is a brief summray of your results.</p>
				</div>
				...
				<div class="thank_you_message grey_box immune_score">
					...
					<?php
						...
						if($entry_fields[90]['value'] < $threshold_level_score_1) {
							...
							echo '<p>'.$threshold_message['head_threshold_level_1_message'].'</p>';
							
						} else if(($entry_fields[90]['value'] >= $threshold_level_score_1) && ($entry_fields[90]['value'] <= $threshold_level_score_2)) {
							
							echo '<p>'.$threshold_message['head_threshold_level_2_message'].'</p>';
							
						} else if(($entry_fields[90]['value'] >= $threshold_level_score_2) && ($entry_fields[90]['value'] <= $threshold_level_score_3)) {
							
							echo '<p>'.$threshold_message['head_threshold_level_3_message'].'</p>';
							
						} else {
							
							echo '<p>'.$threshold_message['head_threshold_level_4_message'].'</p>';
						}
					?>
				</div>
			</div>
